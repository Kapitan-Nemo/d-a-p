...
<template>
  ...
  <button class="mb-3 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" @click="prepare">
    Add new product
  </button>
  ...
  <div :class="editMode ? 'transform-none' : '-translate-x-full'" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform bg-dark-200">
    ...
    <div class="flex flex-col">
      ...
      <!-- <button class="update-product bg-black text-white font-bold py-2 px-4" @click="updateProduct(editProduct.id)">
        Update
      </button> -->
      <button class="create-product bg-black text-white font-bold py-2 px-4" @click="createProducts">
        Create
      </button>
    </div>
  </div>
