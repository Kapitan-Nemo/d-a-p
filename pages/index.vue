<template>
  <div class="w-fulll h-20 bg-black my-6 ml-16 shape">
  ...
  <section>
    <div class="container flex">
      <img width="400" src="@/assets/images/devoted-art-propagadna-logo.png" alt="Devoted Art Propaganda Logo">
      <div class="ml-6">
        <h2 class="w-full text-4xl font-bold mb-6">
          December 2021
        </h2>
        <div class="flex ">
