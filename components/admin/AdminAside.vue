      ...
      <ul class="p-3">
        <li class="mb-3">
          <nuxt-link to="/admin" class="flex items-center p-2 text-white">
            <svg class="w-6 h-6 text-red-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" /><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" />
            </svg>
            <span class="ml-3">Dasboard</span>
          </nuxt-link>
        </li>

        <li class="mb-3">
          <nuxt-link to="/admin/orders" class="flex items-center p-2 text-white">
            <svg class="w-6 h-6 text-red-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" /><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" />
            </svg>
        ...
        <li class="mb-3">
          <nuxt-link to="/admin/products" class="flex items-center w-full p-2 text-white">
            <svg class="w-6 h-6 text-red-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
